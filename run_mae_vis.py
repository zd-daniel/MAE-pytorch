...
def get_args():
    ...
    parser.add_argument('--img_path', default='E:/coco2017/train2017/000000000625.jpg', type=str, help='input image path')
    parser.add_argument('--save_path', default='outputs/', type=str, help='save image path')
    parser.add_argument('--model_path', default='checkpoints/pretrain_mae_vit_base_mask_0.75_400e.pth', type=str, help='checkpoint path of model')
